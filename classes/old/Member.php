...
class Member
{
    ...
    public function __construct($member = null)
    {
        ...
        /* -------------------------------------------------------------------- *
         * There is no logged in 'Member' nor an active session, check the DB 	*
         * -------------------------------------------------------------------- */
        else
        {
            $this->find($member);
    ...
    public function update($fields = array(), $id = null)
    {
        ...
        /* --------------------------------------------------------------------------- 	*
         * Set the this 'Member' object's Id to the $mId set in the second argument 	*
         * --------------------------------------------------------------------------- 	 */
    ...
    /** ---------------------------------------------------------------------------- **
     * 	Member->login($username, $password, $remember)	                      		  *
     *  Added by Reinhardt Zündorf on 25 March 2017									  *
     * ------------------------------------------------------------------------------ *
    ...
    public function login($username = null, $password = null, $remember = false)
    {
        ...
        {
            /* -----------------------------------------------------------------------------------  *
             * Call Member->find('$username') - check whether the username of the user attempting   *
             * to login is valid.                                                                   *
             * -----------------------------------------------------------------------------------  */
...
//                    'sHash' => '123123'));
            ...
            {
                error_log("Member.php -  Could not find the username in the DB.");
            }
        }
    ...
    public function hasPermission($key)
    {
        ...
        if(!isset($group))
        {
            error_log("Member is not in any group and therefore lacks permission data. ");
        }
    ...
    /** ---------------------------------------------------------------------------- **
     * 	Member-> isLoggedIn()				Accessor Method							  *
     * * ---------------------------------------------------------------------------- * */
